<?php include("layout/session.php"); 
   if(!isset($_GET['id'])){
      echo "<script>window.location.href='all-mock'</script>";
      die();
   }
...
<head>
   ...
   <!-- Title -->
   <title>Edit Mock <?php echo $resultM[0]['title']; ?></title>
   <!-- Favicon -->
                        ...
                        <div class="row">
                           <div class="col-md-6 col-sm-6">
                              <div class="seipkon-breadcromb-left">
                                 <h3>Edit Mock <?php echo $resultM[0]['title']; ?></h3>
                              </div>
                           </div>
                           <div class="col-md-6 col-sm-6">
                                 ...
                                 <form data-parsley-validate id="mForm">
                                    <div class="row">
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             ...
                                             <input type="text" name="title" placeholder="Enter Mock Title" class="form-control" required value="<?php echo $resultM[0]['title']; ?>">
                                             <input type="hidden" name="id" value="<?php echo $resultM[0]['id']; ?>">
                                          </div>
                                       </div>
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             ...
                                             <div id="slWrapper" class="parsley-select wd-250"> 
                                                <select name="course_id" class="form-control" data-placeholder="Choose one" data-parsley-class-handler="#slWrapper" data-parsley-errors-container="#slErrorContainer" required>
                                                   ...
                                                   foreach ($courseData as $rowC) { ?>
                                                      <option <?php if($rowC['id']==$resultM[0]['course_id']){ echo "selected";} ?> value="<?php echo $rowC['id']; ?>"><?php echo $rowC['name']; ?></option>
                                                   <?php } ?>
                                                </select>
                                    ...
                                    <div class="row">
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             ...
                                             <input type="text" name="name" placeholder="Enter mock name" class="form-control" required value="<?php echo $resultM[0]['name']; ?>">
                                          </div>
                                       </div>
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             ...
                                             <select name="package_id[]" class="form-control select2" name="" multiple="multiple" data-placeholder="Select">
                                                ...
                                                <?php
                                                $package_idArr=explode(",",$resultM[0]['package_id'] );
                                                $packageData = $functionClass->getRows("mock_packages");
                                                foreach ($packageData as $rowP) { ?>

                                                   <option <?php if(in_array($rowP['id'], $package_idArr)){ echo "selected";} ?> value="<?php echo $rowP['id']; ?>"><?php echo $rowP['title'] ?></option>
                                                <?php } ?>
                                             </select>
                                          </div>
                                       </div>
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             ...
                                             <input type="number" name="questions" placeholder="Mock Questions" class="form-control" required value="<?php echo $resultM[0]['questions']; ?>">
                                          </div>
                                       </div>
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             <label class="control-label">Max Time:</label>
                                             <input type="text" name="max_time" placeholder="Mock time" class="form-control" required value="<?php echo $resultM[0]['max_time']; ?>">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="row">
                                       ...
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             ...
                                             <input type="number" name="marks" placeholder="Mock marks" class="form-control" required value="<?php echo $resultM[0]['marks']; ?>">
                                          </div>
                                       </div>
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             <label class="control-label">Price:</label>
                                             <input type="text" name="price" placeholder="Mock Price" class="form-control" required value="<?php echo $resultM[0]['price']; ?>">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="row">
                                       ...
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             ...
                                             <select class="form-control" name="can_skip">
                                                <option <?php if($resultM[0]['can_skip']=='True'){ echo "selected";} ?> value="True">Yes</option>
                                                <option <?php if($resultM[0]['can_skip']=='False'){ echo "selected";} ?> value="False">No</option>
                                             </select>
                                          </div>
                                       </div>
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             ...
                                             <input type="number" name="duration" placeholder="Mock Duration" class="form-control" required value="<?php echo $resultM[0]['duration']; ?>"> 
                                          </div>
                                       </div>
                                    </div>
                                    <div class="row">
                                          ...
                                          <div class="form-group">
                                             ...
                                             <div id="slWrapper"  class="parsley-select wd-250">
                                                <select name="status" class="form-control" data-placeholder="Choose one" data-parsley-class-handler="#slWrapper" data-parsley-errors-container="#slErrorContainer" required>
                                                   <option <?php if($resultM[0]['status']=='Free'){ echo "selected";} ?> value="Free">Free</option>
                                                   <option <?php if($resultM[0]['status']=='Paid'){ echo "selected";} ?> value="Paid">Paid</option>
                                                </select>
                                                <div id="slErrorContainer"></div>
                                             </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                             ...
                                             <div id="slWrapper1" class="parsley-select wd-250">
                                                <select name="publish" class="form-control" data-placeholder="Choose one" data-parsley-class-handler="#slWrapper1" data-parsley-errors-container="#slErrorContainer" required>
                                                   <option <?php if($resultM[0]['publish']=='True'){ echo "selected";} ?> value="True">Yes</option>
                                                   <option   <?php if($resultM[0]['publish']=='True'){ echo "selected";} ?> value="False">No</option>
                                                </select>
                                                <div id="slErrorContainer"></div>
                                             </div>
                                          </div>
                                    ...
                                    <div class="row">
                                       <div class="col-md-6">
                                                ...
                                                <input type="hidden" name="oldImg" value="<?php echo $resultM[0]['img']; ?>">
                                                </div>      
                                       </div>
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             ...
                                             <select class="form-control" name="language">
                                                ...
                                                <option <?php if($resultM[0]['language']=='Both'){ echo "selected";} ?> value="Both">Both</option>
                                             </select>
                                          </div>
                                       </div>
