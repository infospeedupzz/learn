...
<head>
   ...
   <!-- Title -->
   <title>Add Mock Questions</title>
   <!-- Favicon -->
                                    ...
                                    <div class="mail-sidebar">
                                     <div class="form-group">
                                             ...
                                             <div id="slWrapper" class="parsley-select wd-250"> 
                                                <select name="course_id" class="form-control" data-placeholder="Choose one" data-parsley-class-handler="#slWrapper" data-parsley-errors-container="#slErrorContainer" required onchange="setData(this.value)">
                                          ...
                                          <div class="col-md-12">
                                             <div class="widget_card_two alert">
                                                ...
                                                <div class="widget_card_body collapse" id="notes" aria-expanded="false" style="">
                                                    <textarea rows="5" cols="5" name="details" id="details" class="form-control" placeholder="Textarea"></textarea>
                                                </div>
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-md-12">
                                             <div class="widget_card_two alert">
                                                ...
                                                <div class="widget_card_body collapse" id="notes1" aria-expanded="false" style="">
                                                    <textarea rows="5" cols="5" name="description" id="description" class="form-control" placeholder="Textarea"></textarea>
                                                </div>
                                             </div>
                                          </div>
                              ...
                              <div class="col-md-9 col-sm-8">
                                 <div class="mail-editor compose-page">
                                    ...
                                    Questions Details
                                       ...
                                       <textarea rows="5" cols="5" name="question" id="question" class="form-control" placeholder="Textarea"></textarea>
                                       ...
                                       <div class="row">
                                          ...
                                          <input id="radio-1" name="answer" type="radio" value="1" required>
                                          <label for="radio-1" class="inline control-label">A</label>
                                       </div>
                                          </div>
                                          <div class="col-md-11">
                                             <div class="form-group">
                                                 <textarea rows="5" cols="5" name="option1" id="option1" class="form-control" placeholder="Textarea"></textarea>
                                       ...
                                       <div class="row">
                                          <div class="col-md-1">
                                           <div class="form-group form-radio correct">
                                          <input id="radio-2" name="answer" type="radio" value="2" required>
                                          <label for="radio-2" class="inline control-label">B</label>
                                       </div>
                                          </div>
                                          <div class="col-md-11">
                                             <div class="form-group">
                                                <textarea rows="5" cols="5" name="option2" id="option2" class="form-control" placeholder="Textarea"></textarea>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="row">
                                          <div class="col-md-1">
                                           <div class="form-group form-radio correct">
                                          <input id="radio-3" name="answer" type="radio" value="3" required>
                                          <label for="radio-3" class="inline control-label">C</label>
                                       </div>
                                          </div>
                                          <div class="col-md-11">
                                             <div class="form-group">
                                                <textarea rows="5" cols="5" name="option3" id="option3" class="form-control" placeholder="Textarea"></textarea>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="row">
                                          <div class="col-md-1">
                                           <div class="form-group form-radio correct">
                                          <input id="radio-4" name="answer" type="radio" value="4" required>
                                          <label for="radio-4" class="inline control-label">D</label>
                                       </div>
                                          </div>
                                          <div class="col-md-11">
                                             <div class="form-group">
                                                <textarea rows="5" cols="5" name="option4" id="option4" class="form-control" placeholder="Textarea"></textarea>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="row">
                                          <div class="col-md-1">
                                           <div class="form-group form-radio correct">
                                          <input id="radio-5"  name="answer" type="radio" value="5" required="">
                                          <label for="radio-5" class="inline control-label">E</label>
                                       </div>
                                          </div>
                                          <div class="col-md-11">
                                             <div class="form-group">
                                                 <textarea rows="5" cols="5" name="option5" id="option5" class="form-control" placeholder="Textarea"></textarea>
                                             </div>
                                          </div>
                                       </div>
