                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             ...
                                             <input type="text" name="name" placeholder="Enter Exam Name" class="form-control" required>
                                          </div>
                                       </div>
                                          ...
                                          <div class="col-md-12">
                                             <div class="widget_card_two alert">
                                                ...
                                                <div class="widget_card_body collapse in" id="overview1" aria-expanded="true" style="">
                                                    <textarea rows="5" cols="5" name="overview" id="overview" class="form-control" placeholder="Textarea"></textarea>
                                                </div>
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-md-12">
                                             <div class="widget_card_two alert">
                                                ...
                                                <div class="widget_card_body collapse in" id="exam_date1" aria-expanded="true" style="">
                                                    <textarea rows="5" cols="5" name="exam_date" id="exam_date" class="form-control" placeholder="Textarea"></textarea>
                                                </div>
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-md-12">
                                             <div class="widget_card_two alert">
                                                ...
                                                <div class="widget_card_body collapse in" id="eligibility_criteria1" aria-expanded="true" style="">
                                                    <textarea rows="5" cols="5" name="eligibility_criteria" id="eligibility_criteria" class="form-control" placeholder="Textarea"></textarea>
                                                </div>
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-md-12">
                                             <div class="widget_card_two alert">
                                                ...
                                                <div class="widget_card_body collapse in" id="exam_pattern1" aria-expanded="true" style="">
                                                    <textarea rows="5" cols="5" name="exam_pattern" id="exam_pattern" class="form-control" placeholder="Textarea"></textarea>
                                                </div>
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-md-12">
                                             <div class="widget_card_two alert">
                                                ...
                                                <div class="widget_card_body collapse in" id="syllabus1" aria-expanded="true" style="">
                                                    <textarea rows="5" cols="5" name="syllabus" id="syllabus" class="form-control" placeholder="Textarea"></textarea>
                                                </div>
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-md-12">
                                             <div class="widget_card_two alert">
                                                ...
                                                <div class="widget_card_body collapse in" id="cut_off1" aria-expanded="true" style="">
                                                    <textarea rows="5" cols="5" name="cut_off" id="cut_off" class="form-control" placeholder="Textarea"></textarea>
                                                </div>
                                             </div>
                                          </div>
